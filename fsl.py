...
class MatchingNetworks(FewShotClassifier):
    ...
    output log-probabilities, so we use Negative Log Likelihood Loss.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        print(self.support_features_encoder)
...
"""
We initiate `MatchingNetworks` with a *backbone*. This is the feature extractor we were talking about.
Here, we use as backbone a ResNet50 pretrained on ImageNet, with its head chopped off and replaced by a `Flatten`
...
"""
We create a 4 way 4 shot classifier
"""
